...
#testTNSpecialText() {
#  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_special_text.txt
#  runtest $input
#}

testTNCardinal() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_cardinal.txt
  runtest $input
}

testTNDate() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_date.txt
  runtest $input
}

testTNDecimal() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_decimal.txt
  runtest $input
}

#testTNRange() {
#  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_range.txt
#  runtest $input
#}

#testTNSerial() {
#  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_serial.txt
#  runtest $input
#}
...
testTNFraction() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_fraction.txt
  runtest $input
}

testTNMoney() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_money.txt
  runtest $input
}

#testTNOrdinal() {
#  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_ordinal.txt
#  runtest $input
#}
...
testTNTime() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_time.txt
  runtest $input
}

testTNMeasure() {
  input=$PROJECT_DIR/ka/data_text_normalization/test_cases_measure.txt
  runtest $input
}

testTNWhitelist() {
 input=$PROJECT_DIR/ka/data_text_normalization/test_cases_whitelist.txt
 runtest $input
}

testTNWord() {
 input=$PROJECT_DIR/ka/data_text_normalization/test_cases_word.txt
 runtest $input
}
