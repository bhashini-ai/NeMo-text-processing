...
class TestWhitelist:
    ...
    @parameterized.expand(parse_test_case_file('te/data_text_normalization/test_cases_whitelist.txt'))
    ...
    @parameterized.expand(parse_test_case_file('te/data_inverse_text_normalization/test_cases_whitelist.txt'))
    @pytest.mark.run_only_on('CPU')
    @pytest.mark.unit
