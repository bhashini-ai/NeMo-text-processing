...
from nemo_text_processing.text_normalization.te.graph_utils import MINUS, NEMO_NOT_QUOTE, GraphFst, insert_space
...
class FractionFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        numerator = pynutil.delete("numerator: \"") + pynini.closure(NEMO_NOT_QUOTE) + pynutil.delete("\" ") + pynutil.insert(" ")
